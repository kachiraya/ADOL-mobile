...
//    @IBOutlet var containerView: UIView!
    ...
    var foundObjects: [String] = ["1", "2", "3", "4", "5", "6"]
...
//        itemCount = foundObjects.count;
        ...
        tableView.backgroundColor = UIColor(patternImage: UIImage(named: "iphoneBG")!)
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let cell = tableView.cellForRow(at: indexPath) as! SummaryCell
