    ...
    DataSource.ResultType: Parsable
 {
    ...
    */
    ...
    func addHConstraints() {
        ...
        let collectionHConstraints = NSLayoutConstraint.constraints(withVisualFormat: "H:|-(60)-[collectionView]|", options: NSLayoutFormatOptions.alignAllCenterX, metrics: nil, views: views)
        view.addConstraints(collectionHConstraints)
        
        let textFieldHConstraints = NSLayoutConstraint.constraints(withVisualFormat: "H:|-(80)-[textField]-(80)-|", options: NSLayoutFormatOptions.alignAllCenterX, metrics: nil, views: views)
